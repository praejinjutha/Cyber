  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        if (mounted) {
          setPassedFromPretest(pretestPassedSet.has(2));
        }
          ...
          setAiAnalysisData({
            summary:
              ...
              (latestPercent >= PASS_PERCENT
                ? "คุณมีความเข้าใจด้านความปลอดภัยทางเทคนิคพื้นฐานในระดับที่ดี สามารถนำไปใช้ในสถานการณ์ทั่วไปได้"
                : "คุณเริ่มเข้าใจแนวคิดพื้นฐานแล้ว แต่ยังควรทบทวนการระบุภัยคุกคาม การวิเคราะห์สัญญาณเตือน และการดูแลความปลอดภัยของอุปกรณ์เพิ่มเติม"),
            ...
            <div className="edu-hero__row">
              ...
              <div className="edu-lessons__meta">
                <div className="edu-miniStat">
                  ...
                  <div className="edu-miniStat__value">{UNIT2_TOPICS.length}</div>
                </div>
                <div className="edu-miniStat">
        ...
        <section className="edu-panel">
          ...
          <div className="edu-lessons">
            ...
            <button
              type="button"
              className="edu-lessonCard"
              onClick={() => navigate("/unit2/posttest")}
            >
              <div className="edu-lessonCard__left">
