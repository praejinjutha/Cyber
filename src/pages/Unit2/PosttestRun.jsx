// src/pages/Unit2/PosttestRun.jsx
// ==========================================
// Posttest Runner - Unit 2
// โครงเหมือน Unit 1 ทุกจุด เปลี่ยนแค่ unit=2 และ route กลับหน้าเรียน
// ==========================================
...
export default function PosttestRun() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // 2) ดึง posttest ของ Unit 2 ที่ active
        ...
        // 5) normalize choices ให้เป็น array เสมอ
  ...
  const submitAll = async () => {
    ...
    try {
      ...
      items.forEach((it) => {
        ...
        // choice-based: ตรวจจาก correct_answer
  ...
  // =========================
  // กลับหน้าเรียนพร้อมคะแนน
  // =========================
  const backToLearnWithScore = () => {
    navigate("/unit2/learn", {
      replace: true,
      state: {
        posttestResult: {
  ...
  return (
    <div className="pt-page">
      {/* Popup ระหว่างกำลังส่ง/คำนวณคะแนน */}
      {submitting && (
        ...
        <div className="pt-topbar__inner">
          <div className="pt-title">
            ...
            <div className="pt-title__text">
              ...
              <div className="pt-title__sub">Unit 2</div>
            </div>
          </div>
        ...
        <section className="pt-card pt-card--summary">
          {loading ? (
            ...
            <div className="pt-empty">
              ...
              <div>
                <div className="pt-empty__h">ไม่พบข้อสอบของ Unit 2</div>
              </div>
            </div>
          ) : (
