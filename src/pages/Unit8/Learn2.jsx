...
const MICRO_LESSON = {
  ...
  points: [
    ...
    },
    {
      ...
      body:
        "เนื้อหาที่เสนอด้านเดียวมักทำให้เราเห็นเรื่องนั้นแบบแคบลง ส่วนเนื้อหาที่มีหลายมุมมองจะช่วยให้ตัดสินใจได้รอบคอบขึ้น เช่น มีข้อมูลอีกฝ่าย มีบริบท และไม่รีบด่วนสรุปแทนผู้อ่าน",
    },
  ],
  quickRule:
