...
const UNIT8_TOPICS = [
  {
    id: 1,
    title: "การตั้งคำถามต่อเนื้อหาออนไลน์",
    desc: "เรียนรู้การตั้งคำถามอย่างมีเหตุผลต่อข้อมูลและเนื้อหาที่พบในโลกออนไลน์",
    path: "/unit8/learn1",
  },
  {
    id: 2,
    title: "ความเป็นกลางและอคติของเนื้อหาออนไลน์",
    desc: "สังเกตมุมมองและอคติที่อาจแฝงอยู่ในการนำเสนอเนื้อหาออนไลน์",
    path: "/unit8/learn2",
  },
  {
    id: 3,
    title: "ผลกระทบทางสังคมของการเผยแพร่เนื้อหา",
    desc: "เรียนรู้ผลกระทบที่อาจเกิดขึ้นต่อบุคคลและสังคมจากการเผยแพร่เนื้อหาออนไลน์",
    path: "/unit8/learn3",
  },
  {
    id: 4,
    title: "จริยธรรมในการใช้และเผยแพร่เนื้อหาออนไลน์",
    desc: "ส่งเสริมการใช้และเผยแพร่เนื้อหาออนไลน์อย่างมีจริยธรรมและเคารพผู้อื่น",
    path: "/unit8/learn4",
  },
  {
    id: 5,
    title: "การตัดสินใจอย่างรับผิดชอบในโลกออนไลน์",
    desc: "ฝึกการคิดและตัดสินใจอย่างรอบคอบ รับผิดชอบต่อการกระทำของตนในโลกออนไลน์",
    path: "/unit8/learn5",
  },
  {
    id: 6,
    title: "อคติของระบบปัญญาประดิษฐ์และการใช้งานอย่างรับผิดชอบ",
    desc: "เรียนรู้เรื่องอคติของ AI และแนวทางการใช้งานเทคโนโลยีอย่างรับผิดชอบ",
    path: "/unit8/learn6",
  },
];
...
export default function LearnUnit8() {
