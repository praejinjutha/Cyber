...
const MICRO_LESSON = [
  ...
  },
  {
    ...
    note: "เนื้อหาเดียวกันอาจมีทั้งข้อดีและความเสี่ยง ขึ้นอยู่กับความถูกต้อง บริหน่วย และวิธีที่คนในสังคมรับไปตีความ",
  },
  {
    icon: <FiMessageCircle />,
    title: "ความเข้าใจผิดและความขัดแย้ง มักเริ่มจากข้อมูลที่ยังไม่ครบ",
    points: [
      "ถ้าเนื้อหาถูกส่งต่อทั้งที่ยังไม่ชัดเจนหรือขาดบริหน่วย ผู้คนอาจเข้าใจเรื่องนั้นผิดไปจากความเป็นจริง",
...
const SCENARIOS = [
  ...
  },
  {
    ...
    points: [
      ...
      "การแชร์คลิปต่อโดยไม่ดูบริหน่วย อาจเพิ่มความขัดแย้งและทำให้ผู้เกี่ยวข้องถูกโจมตีเกินกว่าความจริง",
    ],
