...
const UNIT6_TOPICS = [
  {
    id: 1,
    title: "สำรวจพฤติกรรมการใช้สื่อของตนเอง",
    desc: "สำรวจรูปแบบและพฤติกรรมการใช้สื่อของตนเองในชีวิตประจำวัน",
    path: "/unit6/learn1",
  },
  {
    id: 2,
    title: "การจัดสรรเวลาและลำดับความสำคัญในชีวิตประจำวัน",
    desc: "วางแผนเวลาให้เหมาะสมและจัดลำดับความสำคัญของกิจกรรมแต่ละวัน",
    path: "/unit6/learn2",
  },
  {
    id: 3,
    title: "ผลกระทบของการใช้สื่อต่อร่างกาย จิตใจ และสมดุลชีวิต",
    desc: "เรียนรู้ผลกระทบจากการใช้สื่อที่มีต่อสุขภาพกาย สุขภาพใจ และการใช้ชีวิต",
    path: "/unit6/learn3",
  },
  {
    id: 4,
    title: "การตัดสินใจดูแลสุขภาวะดิจิทัลจากสถานการณ์จริง",
    desc: "ฝึกคิด วิเคราะห์ และตัดสินใจดูแลสุขภาวะดิจิทัลจากตัวอย่างสถานการณ์จริง",
    path: "/unit6/learn4",
  },
];
...
export default function LearnUnit6() {
  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        if (mounted) {
          setPassedFromPretest(pretestPassedSet.has(6));
        }
          ...
          setAiAnalysisData({
            summary:
              ...
              (latestPercent >= PASS_PERCENT
                ? "คุณมีความเข้าใจเรื่องสุขภาวะดิจิทัลในระดับที่ดี สามารถสังเกตพฤติกรรมการใช้สื่อของตนเอง ประเมินผลกระทบ และตัดสินใจดูแลสมดุลชีวิตดิจิทัลได้เหมาะสม"
                : "คุณเริ่มตระหนักถึงสุขภาวะดิจิทัลแล้ว แต่ยังควรทบทวนเรื่องการจัดสรรเวลา ผลกระทบของการใช้สื่อ และการตัดสินใจดูแลตนเองจากสถานการณ์จริงเพิ่มเติม"),
            ...
            <div className="edu-hero__row">
              ...
              <div className="edu-lessons__meta">
                <div className="edu-miniStat">
                  ...
                  <div className="edu-miniStat__value">{UNIT6_TOPICS.length}</div>
                </div>
                <div className="edu-miniStat">
        ...
        <section className="edu-panel">
          <div className="edu-panel__head">
            <div className="edu-panel__title">
              <FiFileText /> เรื่องย่อยของ Unit 6
            </div>
          </div>
          ...
          <div className="edu-lessons">
            ...
            <button
              type="button"
              className="edu-lessonCard"
              onClick={() => navigate("/unit6/posttest")}
            >
              <div className="edu-lessonCard__left">
                ...
                <div className="edu-lessonCard__meta edu-lessonCard__meta--posttest">
                  ...
                  <div className="edu-lessonCard__title">แบบฝึกหัด: Unit 6</div>
