...
const UNIT7_TOPICS = [
  {
    id: 1,
    title: "การสังเกตและจำแนกโฆษณาออนไลน์",
    desc: "เรียนรู้วิธีการสังเกตและจำแนกประเภทของโฆษณาออนไลน์ในสื่อดิจิทัล",
    path: "/unit7/learn1",
  },
  {
    id: 2,
    title: "เทคนิคการโน้มน้าวใจในสื่อออนไลน์",
    desc: "ศึกษาวิธีการและกลยุทธ์ในการโน้มน้าวใจของโฆษณาในสื่อออนไลน์",
    path: "/unit7/learn2",
  },
  {
    id: 3,
    title: "ความเสี่ยงของธุรกรรมออนไลน์",
    desc: "เรียนรู้เกี่ยวกับความเสี่ยงที่เกี่ยวข้องกับการทำธุรกรรมออนไลน์และการป้องกัน",
    path: "/unit7/learn3",
  },
  {
    id: 4,
    title: "การตอบสนองอย่างปลอดภัยต่อข้อเสนอที่มีความเสี่ยง",
    desc: "เรียนรู้วิธีการตอบสนองและการป้องกันตนเองจากข้อเสนอที่มีความเสี่ยงในโลกออนไลน์",
    path: "/unit7/learn4",
  },
  {
    id: 5,
    title: "ข้อมูลส่วนบุคคลและนโยบายแพลตฟอร์ม",
    desc: "ทำความเข้าใจเกี่ยวกับการปกป้องข้อมูลส่วนบุคคลและนโยบายแพลตฟอร์มออนไลน์",
    path: "/unit7/learn5",
  },
];
...
export default function LearnUnit7() {
  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        if (mounted) {
          setPassedFromPretest(pretestPassedSet.has(7));
        }
          ...
          setAiAnalysisData({
            summary:
              ...
              (latestPercent >= PASS_PERCENT
                ? "คุณมีความเข้าใจเรื่องการรู้เท่าทันเชิงพาณิชย์และสิทธิผู้บริโภคออนไลน์ในระดับที่ดี สามารถสังเกตโฆษณาออนไลน์ วิเคราะห์เทคนิคการโน้มน้าวใจ ประเมินความเสี่ยงของธุรกรรม และปกป้องข้อมูลส่วนบุคคลได้เหมาะสม"
                : "คุณเริ่มเข้าใจพื้นฐานของการรู้เท่าทันเชิงพาณิชย์แล้ว แต่ยังควรทบทวนเรื่องการจำแนกโฆษณาออนไลน์ การวิเคราะห์กลยุทธ์โน้มน้าวใจ ความเสี่ยงของธุรกรรมออนไลน์ และการปกป้องข้อมูลส่วนบุคคลเพิ่มเติม"),
            ...
            <div className="edu-hero__row">
              <div className="edu-hero__headline">
                <div className="edu-hero__title">
                  Unit 7: การรู้เท่าทันเชิงพาณิชย์และสิทธิผู้บริโภคออนไลน์
                </div>
              ...
              <div className="edu-lessons__meta">
                <div className="edu-miniStat">
                  ...
                  <div className="edu-miniStat__value">{UNIT7_TOPICS.length}</div>
                </div>
                <div className="edu-miniStat">
        ...
        <section className="edu-panel">
          <div className="edu-panel__head">
            <div className="edu-panel__title">
              <FiFileText /> เรื่องย่อยของ Unit 7
            </div>
          </div>
          ...
          <div className="edu-lessons">
            ...
            <button
              type="button"
              className="edu-lessonCard"
              onClick={() => navigate("/unit7/posttest")}
            >
              <div className="edu-lessonCard__left">
