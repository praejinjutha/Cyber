...
const UNIT3_TOPICS = [
  {
    id: 1,
    title: "ภาพลักษณ์ดิจิทัลและผลกระทบของโพสต์",
    desc: "ความหมายของภาพลักษณ์ดิจิทัล + แยกผลกระทบระยะสั้น/ระยะยาว",
    path: "/unit3/learn1",
  },
  {
    id: 2,
    title: "การรับรู้ภาพลักษณ์จากบริบทและผู้ชม",
    desc: "โพสต์เดียวกัน คนดูต่างกันตีความต่างกัน (เพื่อน/ครู/นายจ้าง/บุคคลทั่วไป)",
    path: "/unit3/learn2",
  },
  {
    id: 3,
    title: "พฤติกรรมออนไลน์และความเสี่ยงที่เกิดขึ้น",
    desc: "คัดแยกพฤติกรรมเสี่ยง/ไม่เสี่ยง และจับสัญญาณความเสี่ยงจากสถานการณ์",
    path: "/unit3/learn3",
  },
  {
    id: 4,
    title: "การประเมินความเสี่ยงของรอยเท้าดิจิทัล",
    desc: "ประเมินความเสี่ยงแบบ 3 มิติ: ใครเห็น / อยู่ที่ไหน / ส่งผลอะไร",
    path: "/unit3/learn4",
  },
  {
    id: 5,
    title: "การนำเสนอและปรับโปรไฟล์ออนไลน์",
    desc: "เลือก/ปรับองค์ประกอบโปรไฟล์ให้เหมาะสม สะท้อนตัวตนเชิงบวก",
    path: "/unit3/learn5",
  },
  {
    id: 6,
    title: "การจัดการเนื้อหาและรอยเท้าดิจิทัลในระยะยาว",
    desc: "ตัดสินใจจัดการเนื้อหา (ลบ/ซ่อน/จำกัด/ปรับแก้) ตามระดับความเสี่ยง",
    path: "/unit3/learn6",
  },
];
...
export default function LearnUnit3() {
  ...
  useEffect(() => {
    ...
    const initData = async () => {
      try {
        ...
        if (mounted) {
          setPassedFromPretest(pretestPassedSet.has(3));
        }
          ...
          setAiAnalysisData({
            summary:
              ...
              (latestPercent >= PASS_PERCENT
                ? "คุณมีความเข้าใจเรื่องรอยเท้าดิจิทัลและการจัดการตัวตนออนไลน์ในระดับที่ดี สามารถประเมินความเสี่ยงและปรับพฤติกรรมออนไลน์ได้เหมาะสม"
                : "คุณเริ่มเข้าใจผลกระทบของรอยเท้าดิจิทัลแล้ว แต่ยังควรทบทวนเรื่องการประเมินความเสี่ยง การมองผู้ชมหลายบริหน่วย และการจัดการเนื้อหาออนไลน์ระยะยาวเพิ่มเติม"),
            ...
            <div className="edu-hero__row">
              ...
              <div className="edu-lessons__meta">
                <div className="edu-miniStat">
                  ...
                  <div className="edu-miniStat__value">{UNIT3_TOPICS.length}</div>
                </div>
                <div className="edu-miniStat">
        ...
        <section className="edu-panel">
          <div className="edu-panel__head">
            <div className="edu-panel__title">
              <FiFileText /> เรื่องย่อยของ Unit 3
            </div>
          </div>
          ...
          <div className="edu-lessons">
            ...
            <button
              type="button"
              className="edu-lessonCard"
              onClick={() => navigate("/unit3/posttest")}
            >
              <div className="edu-lessonCard__left">
