...
export default function Group1() {
  ...
  const caseStudies = [
    ...
    {
      title: "กรณีศึกษาเพิ่มเติม: หลอกเด็กเล่นเกม Roblox และเติม Robux ปลอม",
      image: "new2.png",
      description: "มิจฉาชีพใช้ความนิยมของเกม Roblox หรือเกมออนไลน์อื่น ๆ หลอกเด็กและผู้ปกครองผ่านเพจ กลุ่มแชท หรือบัญชีปลอม โดยอ้างว่าสามารถเติม Robux ไอเทมหายาก หรือขายบัญชีเกมในราคาถูกผิดปกติ บางกรณีอาจหลอกให้โอนเงินซ้ำ ขอรหัสผ่านบัญชีเกม หรือชวนคุยนอกแพลตฟอร์มเพื่อควบคุมสถานการณ์",
      lesson: "การซื้อ Robux ไอเทม หรือบริการเติมเงินเกมควรทำผ่านช่องทางทางการเท่านั้น เด็กไม่ควรโอนเงินเอง ไม่ส่งรหัสผ่าน ไม่กดลิงก์รับของฟรี และผู้ปกครองควรตั้งค่าจำกัดการใช้จ่ายหรือยืนยันตัวตนก่อนชำระเงินทุกครั้ง",
      color: "#991b1b"
    }
  ];
