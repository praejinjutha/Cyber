...
export default function Group4() {
  ...
  const caseStudies = [
    ...
    {
      title: "กรณีศึกษาเพิ่มเติม: โอนเงินผิดและการหลอกให้โอนคืน",
      images: ["new1.jpg"],
      description: "มิจฉาชีพอาจใช้เหตุการณ์ 'โอนเงินผิดบัญชี' เป็นข้ออ้างในการกดดันให้เจ้าของบัญชีรีบโอนเงินกลับ โดยอ้างว่าตนเป็นเจ้าของเงินตัวจริง หรือส่งแชทและหลักฐานบางส่วนเพื่อสร้างความน่าเชื่อถือ ทั้งที่เงินดังกล่าวอาจเกี่ยวข้องกับธุรกรรมผิดกฎหมาย หรือเป็นการใช้บัญชีของเราเป็นทางผ่านของเงินหลอกลวง",
      lesson: "หากมีเงินโอนเข้าผิดบัญชี ห้ามรีบโอนคืนให้บุคคลที่ติดต่อมาเอง ควรติดต่อธนาคารโดยตรงผ่านช่องทางทางการ เก็บหลักฐานแชทและสลิปไว้ แล้วให้ธนาคารตรวจสอบและดำเนินการคืนเงินตามกระบวนการ เพื่อป้องกันการตกเป็นส่วนหนึ่งของเส้นทางเงินผิดกฎหมาย",
      color: "#be123c"
    }
  ];
