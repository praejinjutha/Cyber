          ...
          setAiAnalysisData({
            summary:
              ...
              (latestPercent >= PASS_PERCENT
                ? "คุณมีความเข้าใจเรื่องการสื่อสารและมารยาทดิจิทัลในระดับที่ดี สามารถสื่อสารอย่างเหมาะสม เคารพสิทธิผู้อื่น และตัดสินใจใช้เนื้อหาออนไลน์ได้อย่างรับผิดชอบ"
                : "คุณเริ่มเข้าใจพื้นฐานของการสื่อสารดิจิทัลแล้ว แต่ยังควรทบทวนเรื่องการรับมือความขัดแย้งออนไลน์ การใช้สื่ออย่างไม่ละเมิดลิขสิทธิ์ และการเผยแพร่ข้อมูลของผู้อื่นอย่างรับผิดชอบเพิ่มเติม"),
